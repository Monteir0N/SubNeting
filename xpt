...
<html>
<head>
    <title>Network IPv4 Calculator</title>
</head>
<body>
    ...
    <input type="text" id="ipInput" placeholder="Enter IP address" value="198.168.1.52">
    <button onclick="document.getElementById('result').innerHTML = ''">Reset Page</button>
